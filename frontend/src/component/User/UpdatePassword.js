...
import { UPDATE_PASSWORD_RESET } from '../../actions/constants/userConstants';
...
const UpdatePassword = () => {
    ...
    useEffect(() => {
        ...
        if (isUpdated) {
            ...
            alert.success(<div style={{ color: 'white', textAlign : 'center' }}>Profile Updated Successfully</div>)
            navigate("/account");
            dispatch({
