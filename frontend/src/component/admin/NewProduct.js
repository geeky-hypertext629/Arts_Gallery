    ...
    <>
        ...
        <div className="dashboard">
             ...
             <div className="newProductContainer">
                ...
                <div>
                    <SpellcheckIcon />
                    <input type="text" placeholder='Artwork Name' required value={name} onChange={(e)=>setName(e.target.value)} />
                </div>
                <div>
                    <SpellcheckIcon />
                    <input type="text" placeholder='Artwork Author' required value={author} onChange={(e)=>setAuthor(e.target.value)} />
                </div>
                <div>
                    <AttachMoneyIcon />
